  ...
  `}function v(){let e=t.find(e=>e.key===i.profileKey)??t[0],n=d(`Vulneración de derechos en 12 meses`),r=d(`Trabajo sexual declarado`),a=d(`VIH o VIH/TB declarado`),o=d(`Migración internacional`);return`
    ...
    <div class="profile-stack">
      ...
      <article class="panel accent-panel">
        <div class="panel-title">
          <h3>Alcance</h3>
          <p>La muestra concentra liderazgos comunitarios con presencia de mujeres en su diversidad y otras diversidades de género, personas con orientaciones sexuales diversas, personas migrantes, personas vinculadas al trabajo sexual y personas que viven con VIH o VIH/TB.</p>
        </div>
  ...
  `}function w(){return`
    ...
    <div class="two-column equal">
      ...
      <article class="panel prose">
        ...
        <p>El procesamiento estadístico se realizó en Python con pandas y numpy. Los datos del panel se exportaron como JSON agregado para evitar publicar microdatos o identificadores personales.</p>
        <p>${s(e.metadata.privacy)}</p>
      </article>
    </div>
    <div class="two-column equal">
      <article class="panel prose">
        <h3>Panel web y publicación</h3>
        <p>El panel se construyó como aplicación estática con Vite, TypeScript, HTML, CSS y visualizaciones SVG/CSS. La publicación se realizó en GitHub Pages desde archivos estáticos, sin backend ni base de datos.</p>
      </article>
      <article class="panel prose">
